...
const POOL = [
  { id: 7,   name: "Pyraxis the Emberwyrm",        types: ["fire", "wyrm"],      hp: 82, atk: 11, ability: "lance",   rules: ["buff", "ignoreDef"] },
  { id: 8,   name: "Glacith Frostwyrm",            types: ["frost", "wyrm"],     hp: 80, atk: 10, ability: "lance",   rules: ["buff", "aoe"] },
  { id: 11,  name: "Mortis the Lich-King",         types: ["shadow", "mind"],    hp: 80, atk: 10, ability: "sabrina", rules: ["buff", "ignoreDef"] },
  { id: 15,  name: "Balethorn Pit Fiend",          types: ["fire", "shadow"],    hp: 84, atk: 11, ability: "lance",   rules: ["buff", "aoe"] },
  { id: 26,  name: "Storm Djinn",                  types: ["storm", "sky"],      hp: 74, atk: 10, ability: "pikachu", rules: ["buff"] },
  { id: 32,  name: "Seraph of Dawn",               types: ["radiant"],           hp: 76, atk: 10, ability: "sabrina", rules: ["buff"] },
  { id: 38,  name: "Ancient Red Drake",            types: ["fire", "wyrm"],      hp: 72, atk: 10, ability: "lance",   rules: ["buff", "aoe"] },
  { id: 60,  name: "Blue Drake Lord",              types: ["storm", "wyrm"],     hp: 74, atk: 10, ability: "pikachu", rules: ["buff", "ignoreDef"] },
  { id: 74,  name: "Stone Golem, the Eternal",     types: ["stone", "earth"],    hp: 86, atk: 9,  ability: "brock",   rules: ["buff", "ignoreDef"] },
  { id: 88,  name: "Voidspawn Lord",               types: ["shadow", "mind"],    hp: 70, atk: 11, ability: "sabrina", rules: ["buff"] },
  { id: 94,  name: "Earth Elemental, the Eternal", types: ["earth", "stone"],    hp: 84, atk: 9,  ability: "brock",   rules: ["buff", "ignoreDef"] },
  { id: 108, name: "Wraith Lord",                  types: ["spectral", "shadow"], hp: 66, atk: 10, ability: "sabrina", rules: ["buff", "ignoreDef"] },
  { id: 116, name: "Air Elemental, the Eternal",   types: ["sky", "storm"],      hp: 66, atk: 9,  ability: "pikachu", rules: ["buff"] },
  { id: 122, name: "Will-o-Wisp Sovereign",        types: ["radiant", "spectral"], hp: 62, atk: 10, ability: "sabrina", rules: ["buff", "aoe"] },
  { id: 130, name: "Ancient Banshee",              types: ["spectral", "mind"],  hp: 62, atk: 11, ability: "sabrina", rules: ["buff"] },
  { id: 136, name: "Ancient Chimera",              types: ["fire", "plague"],    hp: 76, atk: 10, ability: "lance",   rules: ["buff", "aoe"] },
  { id: 144, name: "Valkyrie Sovereign",           types: ["radiant", "sky"],    hp: 68, atk: 10, ability: "sabrina", rules: ["buff"] },
  { id: 150, name: "Bronze Wyrm, the Eternal",     types: ["storm", "iron"],     hp: 82, atk: 9,  ability: "pikachu", rules: ["buff"] },
  { id: 158, name: "Dryad Lord",                   types: ["verdant"],           hp: 68, atk: 9,  ability: "erika",   rules: ["buff", "aoe"] },
  { id: 66,  name: "Cambion Blade, the Eternal",   types: ["shadow", "martial"], hp: 66, atk: 11, ability: "lance",   rules: ["buff", "ignoreDef", "aoe"] },
];
